...
namespace Fruits.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class FruitsModule : ModuleBase {
        static FruitsModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<FruitsDbContext>());
            // #endif 
        }
        public FruitsModule() {
            InitializeComponent();
